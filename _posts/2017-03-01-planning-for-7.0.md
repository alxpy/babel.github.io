...
This release will be a lot *smaller* than the previous 6.0 release. There shouldn't be any user facing changes other than if you are still using an unsupported Node version.

>If you develop Babel tooling/plugins, you will need to update to support breaking changes to the AST node types.
